...
class UI_VarWindow(object):
    ...
    def setupUi(self, BaseWindow):
        ...
        self.setWindowTitle("Решение варианта")
        self.setWindowIcon(QIcon('icons/icon.png'))

        self.exitAction_var = QAction(QIcon('icons/exit.png'), '&Выход', self)
        self.exitAction_var.setShortcut('Alt+F4')
        self.exitAction_var.setStatusTip('Выйти из программы')
        self.exitAction_var.triggered.connect(qApp.quit)
        self.statusBar()

        self.menubar_var = self.menuBar()
        self.fileMenu_var = self.menubar_var.addMenu('&Файл')
        self.fileMenu_var.addAction(self.exitAction_var)

        self.lbl = QLabel('Окно решения варианта: пока пусто.', self)
        self.lbl.move(90, 20)
...
class UI_BaseWindow(object):
    ...
    def setupUi_continue(self):
        self.setWindowTitle("База заданий")
        self.setWindowIcon(QIcon('icons/icon.png'))
        ...
        self.lbl = QLabel('Выберите задание.', self)
        self.show_btn = QPushButton('Показать', self)
        self.show_btn.clicked.connect(self.show_btn_clicked)

        self.centralWidget = QWidget()
        self.combo = QComboBox()
        self.list_of_items = ['Задание ' + str(num) for num in range(1, 28)]
    ...
    def show_btn_clicked(self):
        task_num = self.combo.currentText().replace('Задание ', '')

        self.lbl2 = QLabel(f'Задание {task_num}.', self)
        ...
        self.task_1_answer = QLabel('Ответ: ' + task_1_data['answer'])
        self.task_1_answer.setWordWrap(True)
        self.task_1_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_1_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_2_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_2_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_3_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_3_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_3_get_file_btn = QPushButton('Получить файл', self)
        ...
        def task_3_get_file_button_clicked():
            destination_path = QFileDialog.getExistingDirectory(self,'Сохранить','.')
            try:
        ...
        self.task_4_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_4_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_5_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_5_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_6_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_6_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_7_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_7_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_8_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_8_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_9_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_9_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_9_get_file_btn = QPushButton('Получить файл', self)
        ...
        self.task_10_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_10_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_10_get_file_btn = QPushButton('Получить файл', self)
        ...
        self.task_11_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_11_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_12_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_12_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_13_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_13_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_14_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_14_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_15_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_15_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_16_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_16_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_17_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_17_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_17_get_file_btn = QPushButton('Получить файл', self)
        ...
        self.task_18_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_18_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_18_get_file_btn = QPushButton('Получить файл', self)
        ...
        self.task_19_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_19_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_20_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_20_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_21_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_21_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_22_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_22_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_23_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_23_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_24_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_24_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_24_get_file_btn = QPushButton('Получить файл', self)
        ...
        self.task_25_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_25_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_26_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_26_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_26_get_file_btn = QPushButton('Получить файл', self)
        ...
        self.task_27_show_ans_btn = QPushButton('Показать ответ', self)
        self.task_27_show_descr_btn = QPushButton('Показать решение', self)
        ...
        self.task_27_get_file_a_btn = QPushButton('Получить файл A', self)
        self.task_27_get_file_b_btn = QPushButton('Получить файл B', self)
...
class UI_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        self.setWindowTitle("ЕГЭ-тренажёр") # заголовок окна
        self.setWindowIcon(QIcon('icons/icon.png'))
        ...
        self.lbl = QLabel('Главное меню', self)
        self.lbl.setFont(QFont('Arial', 20))
        

        self.btn_1 = QPushButton('База заданий', self)
        self.btn_2 = QPushButton('Решение варианта', self)
        self.btn_3 = QPushButton('Выйти', self)
